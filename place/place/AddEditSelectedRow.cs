...
namespace place
{
    public partial class AddEditSelectedRow : Form
    {
        ...
        public AddEditSelectedRow(DataGridViewRow selectedRow,XmlDocument xmlDoc,List<string> checkedListbox)//invoke From Edit button
        {
            InitializeComponent();
            SetFormSize();
        ...
        {
            this.MinimumSize = new System.Drawing.Size(566, 240);
        }

        public AddEditSelectedRow(XmlDocument xmlDoc,bool flag,List<string> checkedListBoxItem)//invoke From Add button
        {
            InitializeComponent();
            SetFormSize();
            checkedListBox.CheckOnClick = true;
        ...
        private void AddTeamElement()
        {
            ...
            foreach (var selectedItem in selectedItems)
            {
                ...
                XmlNode currentTeamNode=null;
                if (!AllowAdd)//if form has opened from Add button
                {
                     currentTeamNode = disziplinNode.SelectSingleNode(
