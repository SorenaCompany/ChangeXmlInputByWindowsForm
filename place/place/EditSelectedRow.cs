...
namespace place
{
    public partial class EditSelectedRow : Form
    {
        ...
        public EditSelectedRow(DataGridViewRow selectedRow,XmlDocument xmlDoc,List<string> checkedListbox)
        {
            InitializeComponent();
        ...
        public EditSelectedRow(XmlDocument xmlDoc,bool flag,List<string> checkedListBoxItem)
        {
            InitializeComponent();
        ...
        private void loadXml(List<string> lists)
        {
            ...
            string desiredValue = selectedRow.Cells["Disziplin"].Value.ToString();

            for (int i = 0; i < checkedListBox.Items.Count; i++)
            {
                if (checkedListBox.Items[i].ToString() == desiredValue)
                {
